...
class StereoContrastiveLoss(nn.Module):
    ...
    def forward(self, ref_fms, tgt_fms, target_l, target_r, weight=1):
        ...
        negative = negative_sampler(ref_fms, tgt_fms, disps_lowr, disps_lowr_right, self.n_neg, low=1, high=25).clone().detach()
        ...
        # print('mask_cont_shape', mask_cont.shape)
        logits *= mask_cont
        ...
        self._dequeue_and_enqueue(key[:, sampler_h, sampler_w, sampler_neg, :,].squeeze().detach().clone())
