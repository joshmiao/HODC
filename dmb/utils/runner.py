...
class Runner(object):
    ...
    def train(self, data_loader, **kwargs):
        ...
        # if self._epoch == start_epoch:
        if 'whitening' in self.cfg.model and self.cfg.model.whitening:
        ...
        for i, data_batch in enumerate(data_loader):
            ...
            outputs = self.batch_processor(
                self.model, data_batch, train_mode=True, epoch=self._epoch, cal_cov=False, cov_list=self.cov_list_gather, max_epochs=self._max_epochs, **kwargs)
